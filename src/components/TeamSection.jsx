        ...
        <Col xs={12} md={6} className="my-auto">
          ...
          <Card.Body>
            ...
            <p className="TeamCardText">
              Milo earned his B.S in Computer Science and Masters in AI at MIT,
              where his research focused on robotic perception, state estimation, and learning. He has experience
              developing computer vision and mapping software at autonomous robotics startups including Skydio, Optimus
              Ride, Adaviv, and Kespry.
            </p>
        ...
        <Col xs={12} md={6} className="my-auto">
          ...
          <Card.Body>
            ...
            <p className="TeamCardText">
              ...
              a Masters in AI at MIT, where his research focused on vision, reinforcement learning, and motion planning.
              His industry robotics experience includes multi-agent thermalling
